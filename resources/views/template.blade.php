...
if (Config::get('languages')[App::getLocale()] == "English") {
        ...
        <div class="container" id="main-container">
                ...
                <ul class="nav nav-list">
                    ...
                    <ul class="nav nav-list">
                        <li id="service">
                            ...
                            <ul class="submenu">
                                <li id="main_service"><a href="{{url('service')}}">@lang('messages.services.services')</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-list">
                        <li id="item">
                            <a href="#" class="dropdown-toggle">
                                <i class="fa fa-building"></i>
                                <span>@lang('messages.items.items')</span>
                                <b class="arrow fa fa-angle-right"></b>
                            </a>

                            <ul class="submenu">
                                <li id="item_index"><a href="{{url('item')}}">@lang('messages.items.items')</a></li>
                                <li id="item_create"><a href="{{url('item/create')}}">@lang('messages.items.create_item')</a></li>
                            </ul>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-list">
                        <li id="country">
                            <a href="#" class="dropdown-toggle">
                                ...
                                <span>@lang('messages.country.countries_and_cities')</span>
                                <b class="arrow fa fa-angle-right"></b>
                            </a>

                            <ul class="submenu">
                                <li id="country_index"><a href="{{url('country')}}">@lang('messages.country.countries')</a></li>
                                <li id="cities"><a href="{{url('city')}}">@lang('messages.cities.cities')</a></li>
                            </ul>
                        </li>
                    </ul>
                    @endif
            ...
            <div class="footer" align="center" style=" position: absolute; width: 100%; bottom: 0;">
                <p>{{\Carbon\Carbon::now()->year}} © Olic</p>
            </div>
