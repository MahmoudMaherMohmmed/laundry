@extends('template')
@section('page_title')
    @lang('messages.clothes_types.clothes_types')
@stop
@section('content')
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-black">
                        <div class="box-title">
                            <h3><i class="fa fa-table"></i> @lang('messages.clothes_types.clothes_types')</h3>
                        </div>
                        <div class="box-content">
                            <div class="btn-toolbar pull-right">
                                <div class="btn-group">
                                    @if (get_action_icons('clothes_type/create', 'get'))
                                        <a class="btn btn-circle show-tooltip" title=""
                                            href="{{ url('clothes_type/create') }}" data-original-title="Add new record"><i
                                                class="fa fa-plus"></i></a>
                                    @endif
                                    <?php $table_name = 'clothes_types';
                            ...
                            <div class="table-responsive">
                                <table id="example" class="table table-striped dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        @foreach ($clothes_types as $value)
                                            <tr>
                                                ...
                                                <td class="visible-md visible-xs visible-sm visible-lg">
                                                    <div class="btn-group">
                                                        @if (get_action_icons('clothes_type/{id}/edit', 'get'))
                                                            <a class="btn btn-sm show-tooltip"
                                                                href='{{ url("clothes_type/$value->id/edit") }}'
                                                                title="Edit"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        @if (get_action_icons('clothes_type/{id}/delete', 'get'))
                                                            <form action="{{ route('clothes_type.destroy', $value->id) }}"
...
@section('script')
    <script>
        ...
        $('#clothes_type_index').addClass('active');
    </script>
@stop
